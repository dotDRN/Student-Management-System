...
class MessageService {
    ...
    async sendMessage(userId: string, conversationId: string, payload: SendMessageDto) {
        ...
        if (payload.replyToId) {
            ...
            if (parentMessage.conversationId !== conversationId) {
                throw new BadRequestError("Reply target message belongs to a different conversation.");
            }
        }

        // Use a transaction to ensure message and attachments are created atomically,
        // and also update the conversation's updatedAt timestamp.
    ...
    async editMessage(userId: string, messageId: string, payload: UpdateMessageDto) {
